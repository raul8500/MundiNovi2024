...
var _chunk4F67E254cjs = require('./chunk-4F67E254.cjs');
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      ...
      if (_optionalChain([api, 'optionalAccess', _7 => _7.webhooks, 'access', _8 => _8[path], 'optionalAccess', _9 => _9[method]])) {
        ...
        return new (0, _chunk4F67E254cjs.Webhook)(api, path, method, operation);
      }
    }
    ...
    return new (0, _chunk4F67E254cjs.Operation)(this.api, path, method, operation);
  }
  ...
  async dereference(opts = { preserveRefAsJSONSchemaTitle: false }) {
    ...
    if (api.components && api.components.schemas && typeof api.components.schemas === "object") {
      Object.keys(api.components.schemas).forEach((schemaName) => {
        if (_chunkQBBP72GCcjs.isPrimitive.call(void 0, api.components.schemas[schemaName]) || Array.isArray(api.components.schemas[schemaName]) || api.components.schemas[schemaName] === null) {
          return;
        }
...
exports.Oas = Oas;
//# sourceMappingURL=chunk-MA52ZYTE.cjs.map